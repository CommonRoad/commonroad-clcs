...
foreach(fc_target Eigen3 spdlog)
...
set(crccosy_install_cmakedir ${CMAKE_INSTALL_LIBDIR}/cmake/${PROJECT_NAME})
set(crccosy_config_file ${CMAKE_CURRENT_BINARY_DIR}/${PROJECT_NAME}Config.cmake)
set(crccosy_version_file ${CMAKE_CURRENT_BINARY_DIR}/${PROJECT_NAME}ConfigVersion.cmake)

configure_package_config_file(
        ${PROJECT_SOURCE_DIR}/cmake/${PROJECT_NAME}Config.cmake.in
        ${crccosy_config_file}
        INSTALL_DESTINATION ${crccosy_install_cmakedir}
)

write_basic_package_version_file(
        ${crccosy_version_file}
        COMPATIBILITY AnyNewerVersion
)

install(FILES ${crccosy_config_file}
        ${crccosy_version_file}
        DESTINATION  ${crccosy_install_cmakedir}
)
